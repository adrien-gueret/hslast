(function() {
    ...
    var notificationModalButton = document.getElementById('notificationModalButton');
    var notificationModalCloseButton = document.getElementById('notificationModalCloseButton');
    ...
    function translateUI(client) {
        ...
        client.onReady(() => {
            client.getLastExpansionName().then(function(expansionName) {
                document.getElementById('lastExpansionName').innerHTML = translate('lastExpansionName', expansionName);
            });

            client.getLastExpansionCardCount().then(function(count) {
                revealedCardCount = count.revealed;
                document.getElementById('revealedCardCount').innerHTML = translate('revealedCardCount', count.revealed, count.total);
            });
        });        
    }
    ...
    function showCardDetail(domElementWithCardData, client) {
        ...
        if (currentlyWatchedDomCardListItem.previousSibling) {
            ...
            cardDetailPrevButton.setAttribute('href', '#' + currentlyWatchedDomCardListItem.previousSibling.id);
        } else {
        ...
        if (currentlyWatchedDomCardListItem.nextSibling) {
            ...
            cardDetailNextButton.setAttribute('href', '#' + currentlyWatchedDomCardListItem.nextSibling.id);
        } else {
        ...
        client.getCardClasses(card).then(function(classes) {
            cardDetailClasses.innerHTML = classes.map(function(cardClass) {
    ...
    function prepareApp(client) {
        ...
        notificationModalCloseButton.addEventListener('click', hideNotificationModal);
        ...
        function toggleNotificationsIcon() {
            notificationModalButton.innerHTML = translate('notificationModalButton', areNotificationsEnabled);
